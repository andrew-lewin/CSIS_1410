 ...
 * 
 * The class is implemented to be immutable.
 * Immutability is a very desirable feature of a data type.
 * Once the client program initializes a Vector, it can no longer
 * change any of its fields neither directly nor indirectly. 
 *  
 * ****************************************************************/
...
public class Vector { 
    ...
    /**
     * Creates a vector based on the data provided 
     * It creates a defensive copy so that the clien't won't be able 
     * to alter the components of the vector
     ...
     * Returns the inner product dot product of this vector and the other vector.
     ...
     * Returns the difference between this vector and the other vector
     * @param other vector to add to this vector
     * @return this - other
     */
     ...
     * Creates and returns a new object that is the product of this vector and the factor
